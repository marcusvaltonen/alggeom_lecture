...
corresponding to null vectors with last element equal to zero.
...
Following the suggestions by the authors, we choose the one with lowest degree, corresponding
...
instead we get an elimination template of size $59\times 61$.
\end{example}
