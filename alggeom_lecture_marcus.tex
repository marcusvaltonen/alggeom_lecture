...
the hidden variable trick can be used to reduce the number of parameters, but still
...
Sometimes we are able to eliminate variables even if there are no linear relationship. This
...
\begin{aligned}
    g_2(x,y,w) &= w g_3(x,y,w), \\
    w g_1(x,y,w) &= z g_3(x,y,w)\;.
\end{aligned}
\end{equation}
...
This section is based on~\cite{kukelova-etal-2017-cvpr}.
Practical examples: \cite{ding-etal-2019-iccv,valtonenoernhag-icpram-2019}
