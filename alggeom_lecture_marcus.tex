...
By looking at a specific instance we can use Macaulay2 to show that there are in
general four solutions to this problem; however,
...
the normalized nullvector with last element equal to one. This means that $\mat{M}(z)$ must
